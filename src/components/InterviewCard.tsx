    ...
    return (
        <div className="mx-8 my-4 h-10 mb-32">
            ...
            <div className="flex ">
                ...
                <div className="flex ml-2 overflow-hidden w-full">
                    {storeType.map((el, index) => (
                        <p key={index} className="text-xs w-96 text-center mr-1 bg-gray-200 px-2 py-1 rounded-2xl">
                            {el}
                        </p>
                    ))}
                </div>
            ...
            <div className="flex rounded-xl shadow-lg h-10 items-center p-4">
                ...
                <button onClick={interviewWorker} className=" bg-cyan-500 px-2 py-1 rounded-lg ">
