...
const OwnerRecruitNoticePage = () => {
    ...
    return (
        <div className="">
            ...
            <div className="mx-8">
                {/* 매장이름 */}
                <InputValue2 label={'매장이름'} setValue={setValue} dict_key={'store_name'} dict_value={recruitData['store_name']} />
                {/* 매장주소 */}
                <InputValue2 label={'매장주소'} setValue={setValue} dict_key={'address'} dict_value={recruitData['address']} />
                {/* 알바유형 */}
                <InputValue2
                    mode="SELECT"
                    label={'알바유형'}
